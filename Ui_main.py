...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1000, 492)
        # MainWindow.setMaximumSize(QtCore.QSize(1000, 492))
        MainWindow.setBaseSize(QtCore.QSize(1000, 492))
        icon = QtGui.QIcon()
        ...
        # 設定介面大小
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 20, 1100, 80))
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 140, 861, 61))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(350, 260, 160, 90))
